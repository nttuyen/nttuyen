...
function kubrick_header_image_url() {
	if ( $image = kubrick_header_image() )
		...
		$url = get_template_directory_uri() . '/images/blueskyheader.jpg';
...
// <![CDATA[
	...
	function kDefaults() {
		...
		document.getElementById('header').style.background = 'url("<?php echo get_template_directory_uri(); ?>/images/blueskyheader.jpg") center no-repeat';
